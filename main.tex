...
\vspace{2ex}
\headright{Education}
\textsc{Master in Data Sciense(supervised by \href{https://scholar.google.com/citations?user=g0onknYAAAAJ&hl=en}{Dr. Effati}).} Faculty of Mathematics. \textit{Ferdowsi University of Mashhad}. \dates{2022--2024} \\
...
\headright{Skills}
\is
\textsc{Programming Languages:} {Python}
\is
\textsc{Libraries:} {Pandas, Numpy, Sk-learn, Vega-Altair, Matplotlib}
\is
\textsc{AI Frameworks:} {LangChain, ChainLit}
\is
\textsc{Tools:} {Git, \LaTeX}
...
\end{minipage}
% %Scrum,Agile,Jira,personal site,
