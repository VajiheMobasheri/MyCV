...
\is
\textsc{AI Frameworks:} {LangChain, ChainLit, Dify}
\is
\textsc{Tools:} {Git, PowerBi, Tableau, \LaTeX}
...
\headright{Selected Cources}
	...
	\begin{tabbing}
    \hspace{10cm} \= \kill
    \smaller{Big Data} \> 3.6/4 \\[0.2cm]
    \smaller{Text Mining} \> 3.5/4 \\[0.2cm]
    \smaller{Machine Learning} \> 3.4/4 \\[0.2cm]
    \smaller{Data Science Algorithms} \> 3.4/4 \\[0.2cm]
    \smaller{Optimization and Neural Networks} \> 3.4/4 \\[0.2cm]
    \smaller{Mathematical Foundations of Data Science} \> 3.4/4 \\[0.2cm]
    \end{tabbing}
